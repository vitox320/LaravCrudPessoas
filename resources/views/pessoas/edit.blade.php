...
<html lang="pt-br">
  ...
  <form action="{{route('atualizar_pessoa',['id'=>$pessoa->id])}}" method="POST">
      ...
      <div class="form-group">
          ...
          <input type="text" class="form-control" name="nome" id="nome" value="{{$pessoa->nome}}" placeholder="ex:Maria" required>
      </div>
      <div class="form-group">
          <label for="sobrenome">Sobrenome</label>
          <input type="text" class="form-control" name="sobrenome" id="sobrenome" value="{{$pessoa->sobrenome}}" placeholder="ex:Silva" required>
      </div>
      <div class="form-group">
          <label for="email">Email</label>
          <input type="email" class="form-control" name="email" id="email" value="{{$pessoa->email}}" placeholder="ex:Silva@gmail.com" required>
      </div>
      <div class="form-group">
          <label for="telefone">Telefone</label>
          <input type="text" class="form-control" name="telefone" id="telefone" value="{{$pessoa->telefone}}" required>
      </div>
      ...
      <div class="form-group">
          ...
          <input type="text" name="cpf" class="form-control" id="cpf" value="{{$pessoa->cpf}}">
      </div>
      <div class="form-group">
          <label for="cnpj">CNPJ</label>
          <input type="text" name="cnpj" class="form-control" id="cnpj" value="{{$pessoa->cnpj}}">
      </div>
